...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6adf133dd53882978d3529d3e5481f59e1afb621f999e3a9ffe6966510eb0dcf.js',function(){input.required=false;search();});}
