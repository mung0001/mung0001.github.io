...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bcffbb359d9cf518ce7644ca99edf2c578b019364b74f37bbbe8477d6777c122.js',function(){input.required=false;search();});}
