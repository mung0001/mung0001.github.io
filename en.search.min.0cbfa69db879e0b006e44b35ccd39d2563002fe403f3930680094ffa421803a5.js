...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e19b28af7a475d3987fda8ba52c120fefcd10130bdfd9b0a32fe7f81faaecc5d.js',function(){input.required=false;search();});}
