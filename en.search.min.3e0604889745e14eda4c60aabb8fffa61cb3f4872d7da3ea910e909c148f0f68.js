...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8dd9aabe52db871d3baebe884f69cfa3ead7e2d94f5a521685571465ed3c48d5.js',function(){input.required=false;search();});}
