...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.766ca5ab53e905ffd037300d47db38b47fe5699dd8b9288f6e2f7d394db800e0.js',function(){input.required=false;search();});}
