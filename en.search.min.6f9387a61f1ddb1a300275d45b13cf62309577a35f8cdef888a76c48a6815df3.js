...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.947baac520ec97e8758108f0faeb5392bfd07c2edd26138497a807eded7d12c1.js',function(){input.required=false;search();});}
