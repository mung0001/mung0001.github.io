...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b899bc2c38332416506dd7df10d6741efcda86842a79fa7309f2830512047a43.js',function(){input.required=false;search();});}
