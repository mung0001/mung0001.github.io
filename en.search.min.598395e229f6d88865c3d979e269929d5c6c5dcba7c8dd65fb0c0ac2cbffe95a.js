...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.bc9975fddee234db939095f3a8976bd1882a54d7a2b027ae61caeb86d9de351e.js',function(){input.required=false;search();});}
