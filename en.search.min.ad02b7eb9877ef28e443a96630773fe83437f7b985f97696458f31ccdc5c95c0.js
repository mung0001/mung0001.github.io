...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.05e19ee756c0415c903f1eb5187d0bf93deda0fa0f8d852b29602f61d4020360.js',function(){input.required=false;search();});}
