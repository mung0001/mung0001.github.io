...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7fdb5402f55fc4efe318e8fc8fbd4c973d41c08f48481a7fc832a0e9aa73cf57.js',function(){input.required=false;search();});}
