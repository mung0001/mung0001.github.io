...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0fcf9108966302a056af0b98fbe9119e0be2bdb5e7a6c7e5f1ef53fcaee2c648.js',function(){input.required=false;search();});}
