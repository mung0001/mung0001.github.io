...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.70c0cd6357f9cd97a479ebf9cbe96c66878120f65938da8a0a6bd9bd652409cd.js',function(){input.required=false;search();});}
