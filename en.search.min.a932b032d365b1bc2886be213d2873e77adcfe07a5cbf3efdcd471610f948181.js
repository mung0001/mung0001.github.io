...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dfc9c201a6eeaadd60b168c23feab5d4b694c733c6415ba3dd9cec16ddbfd068.js',function(){input.required=false;search();});}
