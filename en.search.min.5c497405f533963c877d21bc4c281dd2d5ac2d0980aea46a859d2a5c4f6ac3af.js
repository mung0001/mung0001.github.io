...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.77f9b480161c649f6e61a57515760755c5820eb5b1027126f706847a5725ea7b.js',function(){input.required=false;search();});}
