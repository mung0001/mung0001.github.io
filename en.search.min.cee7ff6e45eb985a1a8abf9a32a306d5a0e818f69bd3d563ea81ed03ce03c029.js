...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a749f2acc4981e4e7ca1a4d8d3e288687fa83d10795707c124439eead3d0bf19.js',function(){input.required=false;search();});}
