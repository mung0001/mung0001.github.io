...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.398bf4945097713701c0dfe9de41ffb473ac51b80584b182184fa12cc37697d8.js',function(){input.required=false;search();});}
