...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8ba4710c38d0867e5fb8d00abdcaa8d23bde7f2b5393f41be7a8cdedcd2709db.js',function(){input.required=false;search();});}
