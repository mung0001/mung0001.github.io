...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6b55937626d47d8d6a2c359984dffe54e076d45c4a730931445c5e5921008412.js',function(){input.required=false;search();});}
