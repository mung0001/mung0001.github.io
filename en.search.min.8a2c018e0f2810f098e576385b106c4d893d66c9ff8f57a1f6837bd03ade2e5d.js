...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.533e43b51daf453d8713e2592c6686d290b70db8543df334e51d15560db80611.js',function(){input.required=false;search();});}
