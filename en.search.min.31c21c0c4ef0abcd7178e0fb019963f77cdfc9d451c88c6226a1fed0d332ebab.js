...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.56714de893935135be97c3d938312660cecb628522357564c9d6204c4f76b8a7.js',function(){input.required=false;search();});}
