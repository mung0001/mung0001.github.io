...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.49f596e9e206e304be674da221b0262cebcfe4306f1ca8bf019a0a0681a789a3.js',function(){input.required=false;search();});}
