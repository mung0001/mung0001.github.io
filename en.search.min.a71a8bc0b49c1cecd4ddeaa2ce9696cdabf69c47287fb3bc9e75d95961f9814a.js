...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3f218cb3e98489264ac4db463ac915f96d30440a58339c05c054049676682fc0.js',function(){input.required=false;search();});}
