...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.96daae0d16c6c1109438a0e2e1229bd384bce237e866e79601a38aa84ba9ae14.js',function(){input.required=false;search();});}
