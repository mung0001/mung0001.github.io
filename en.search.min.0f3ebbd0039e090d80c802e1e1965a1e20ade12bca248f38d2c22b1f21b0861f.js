...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cbf92d5bc8dd668aba7c6f19cc16d264a8c750884703bd105db2db359ef629ee.js',function(){input.required=false;search();});}
