...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4419a4d253f0f30ef8af36d1d721bd02d697da43a6ed9a9a2fd631ba22cdf2c2.js',function(){input.required=false;search();});}
