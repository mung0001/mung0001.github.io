...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.460307112488288aa834a16d248ce7a4c950e8352a034a8be7d1db66646867b9.js',function(){input.required=false;search();});}
