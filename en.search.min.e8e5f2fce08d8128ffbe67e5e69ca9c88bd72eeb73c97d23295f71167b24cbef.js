...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e855931f45e27423e281fb85fdc10cd79b7169fefe2e9fc4d2ebf1a760cf26c7.js',function(){input.required=false;search();});}
