...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.a0ec0c755acedecd7c93a041915fcf2cc9a5d6bdd40233b8f7e4a5d0be098bd8.js',function(){input.required=false;search();});}
