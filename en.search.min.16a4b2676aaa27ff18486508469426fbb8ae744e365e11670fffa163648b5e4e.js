...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f1cc184d8fa3954a87e6e9293f9211d1aa5a8badd4ab7297855328c6d8bded9c.js',function(){input.required=false;search();});}
