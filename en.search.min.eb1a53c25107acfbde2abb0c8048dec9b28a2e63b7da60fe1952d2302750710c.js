...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4a6f04a0afb9c1b083720680b0babf70f40fe084aeaf82d824a19f51a511a0d7.js',function(){input.required=false;search();});}
