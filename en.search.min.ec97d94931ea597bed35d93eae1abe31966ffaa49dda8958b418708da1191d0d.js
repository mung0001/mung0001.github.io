...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3345bf2a98367a51e5fd2d4dd5f1475329722e1a31958576957628200484696a.js',function(){input.required=false;search();});}
