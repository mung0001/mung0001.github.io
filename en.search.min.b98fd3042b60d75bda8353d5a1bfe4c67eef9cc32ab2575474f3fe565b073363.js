...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5b87395e27a0bda00dd043d92e1e9c065c685deea259c896fc5798a7705255bb.js',function(){input.required=false;search();});}
