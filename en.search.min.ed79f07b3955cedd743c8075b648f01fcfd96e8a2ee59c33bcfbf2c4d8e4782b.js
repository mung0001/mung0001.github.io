...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.c000d6add635df4b100b03961330762a2384897ad04dc44c15d6e5dd986b8d9d.js',function(){input.required=false;search();});}
